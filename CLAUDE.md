...
with no real coverage hole. **The macOS validation pass has NOT been run** —
`editor/validation/3.2.3-obj-import-tinyobjloader.md` holds thirteen unchecked rows.
