...
(2026-08-22): 11 of 12 rows PASS, and the twelfth found a REGRESSION** (below). **The headline is
...
before the merge, and macOS-validated (`editor/validation/3.6.3-tonemap-gamma.md`) — ✅ **11 of 12
ROWS PASS**, with row 2b's own assertion passing and its CONTROL uncovering the picking regression
recorded above and fixed by PR #87 (`2c911e2`). CLOSES Epic 3.6 in code.** Sized S
