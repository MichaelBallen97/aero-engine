...
**3.6.2 — Directional shadow map: COMPLETE IN CODE on `feat/3.6.2-directional-shadow-map` (sixteen
commits), its code-review round CLOSED (eight findings, three blocking, all fixed), NOT YET PUSHED,
and PENDING its twelve-row macOS pass.** The renderer
