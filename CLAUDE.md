...
panel's five slots. **FOURTEEN commits.** `ctest -N` **174 -> 178** — its FIRST move since 3.7.3, and
...
**1404 / 1915 / 208 / 40 / 59 / 10 / 28**; guards **516 / 92 / 163 / 92 / 165 / A=6 B=86 / 11-3-55 /
...
write has the second clobber the first.
...
at the branch point, not carried). doctest **1404 / 1915 / 208 / 40 / 59 / 10 / 28**, up from E.3.1's
**1404 / 1886 / 201 / 40 / 55 / 7 / 28**. **FOUR of the seven move and THREE must not**: shell
1886 -> 1915, imgui 201 -> 208, inspector 55 -> 59 and meta 7 -> 10 all move, while `aero_tests` (1404)
...
**THREE PAGES HAVE NOT BEEN RUN ON ANY PLATFORM: E.1.5's, E.3.2's and E.3.3's.** **E.3.3's is fourteen
rows** (`editor/validation/E.3.3-asset-reference-picker.md`, gitignored, so it enters no commit), and
**six of them are the ONLY cover a declared sabotage seed has anywhere**: row 1 for `S45` (the value
...
merged; only E.3.4 is planning only.** **E.3.3 (asset-reference picker) is the newest — fourteen
commits, the full local gate green on both presets and both reduced configurations, the 46-seed
sabotage matrix run in full, and a code-review round closed.** It moved `ctest -N` for the first time
since 3.7.3 (**174 -> 178**, four `reflect-gen.asset_*` process cases) and took the ImGui-tier case-id
ceiling to **`I168`**; `I162`–`I168` are claimed, so **`I169` is the next free id**. **Its validation
