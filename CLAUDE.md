...
**E.1.1 (Debug line renderer) is MERGED; the other 23 tasks are planning only.** Six epics, 24
...
### E.1.1 — Debug line renderer (merged) — the first Phase E task
...
| **Phase E** — Editor Experience | **OPEN. E.1.1 merged; 23 tasks remain, planning only.** Inserted between 3 and 4; six epics, 24 tasks in `docs/tasks/phase-E.md`. Viewport legibility (E.1), lighting & environment (E.2), inspector & context routing (E.3), project/scene/asset management (E.4), content-creation UX (E.5), shell identity (E.6). **Nothing in the phase is validated on any platform**: E.1.1's page is written and not run. |
