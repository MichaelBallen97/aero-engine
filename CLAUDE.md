...
| **Phase 2** — Editor | Epic 2.1 (ImGui integration) **CLOSED in code**, macOS human-validated PASS; Windows/Linux rows pending (`editor/VALIDATION.md`). Epic 2.2 (Core panels) **OPEN** — 2.2.1 Hierarchy and 2.2.2 Inspector landed. |
| **Next task** | **2.2.3 Viewport panel** — see `docs/tasks/phase-2.md`. |
