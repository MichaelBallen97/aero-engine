...
— 3.2.1 glTF, 3.2.2 FBX, 3.2.3 OBJ and 3.2.4 Blender CLI.**
...
**Its macOS validation pass has NOT been run** — `editor/validation/3.2.4-blender-cli-blend-import.md`
holds fifteen unchecked rows, and rows 2, 3, 6 and 12 are the only cover for the requirement-level
claims with no automated proof.** It is the fourth importer path and the only one that is
...
Test inventory at HEAD (`5ab07f3`, `main`), every number
