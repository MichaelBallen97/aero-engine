...
`feat/3.6.1-frustum-culling` (eleven green commits, three of them closing and recording the
code-review round), NOT pushed and NOT merged, and PENDING its ten-row macOS pass.** The renderer learns to not draw. `.aeromesh` has carried `CookedBounds` per submesh and
