...
| **Phase 2** — Editor | Epic 2.1 (ImGui integration) **CLOSED in code**, macOS human-validated PASS; Windows/Linux rows pending (`editor/VALIDATION.md`). Epic 2.2 (Core panels) **OPEN** — 2.2.1 Hierarchy, 2.2.2 Inspector and 2.2.3 Viewport landed, each macOS human-validated PASS with Windows/Linux rows pending. |
| **Next task** | **2.2.4 Asset browser stub** — see `docs/tasks/phase-2.md`. |
