...
panel's five slots. **FIFTEEN commits.** `ctest -N` **174 -> 178** — its FIRST move since 3.7.3, and
...
**THREE PAGES HAVE NOT BEEN RUN ON ANY PLATFORM: E.1.5's, E.3.2's and E.3.3's.** **E.3.3's is fifteen
