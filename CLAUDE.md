...
is COMPLETE IN CODE on `feat/3.6.3-tonemap-gamma-pass` (ten commits, cut from `main` @ `64df342`) —
...
**3.6.3 — Tonemap/gamma pass: COMPLETE IN CODE on `feat/3.6.3-tonemap-gamma-pass`, ten commits, cut
