...
Needs a native human pass. No checks recorded yet. Tick the rows above as you go, then replace this
line with the result (`✅ PASS (date)` / `⚠️ PARTIAL` + which rows failed and how).
