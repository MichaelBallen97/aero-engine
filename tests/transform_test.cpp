...
TEST_CASE("transform: every World seeds engine::Transform by construction") {
    World w;
    CHECK(w.componentTypeCount() == 6);  // the six built-ins, Transform first (1.3.2 .. 3.5.2)
    ...
    World a;
    const World b;
    CHECK(a.componentTypeCount() == 6);  // the six built-ins, Transform first (1.3.2 .. 3.5.2)
    CHECK(b.componentTypeCount() == 6);  // the six built-ins, Transform first (1.3.2 .. 3.5.2)
...
TEST_CASE("transform: move semantics do not re-seed or lose the table") {
    ...
    CHECK(moved.componentTypeCount() == 6);  // the six built-ins, Transform first (1.3.2 .. 3.5.2)
