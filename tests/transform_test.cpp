...
TEST_CASE("transform: every World seeds engine::Transform by construction") {
    World w;
    CHECK(w.componentTypeCount() == 5);  // Transform+Camera+DirectionalLight+PointLight(1.3.3)+MeshRenderer(1.4.1)
    ...
    World a;
    const World b;
    CHECK(a.componentTypeCount() == 5);  // Transform+Camera+DirectionalLight+PointLight(1.3.3)+MeshRenderer(1.4.1)
    CHECK(b.componentTypeCount() == 5);  // Transform+Camera+DirectionalLight+PointLight(1.3.3)+MeshRenderer(1.4.1)
...
TEST_CASE("transform: move semantics do not re-seed or lose the table") {
    ...
    CHECK(moved.componentTypeCount() == 5);  // Transform+Camera+DirectionalLight+PointLight(1.3.3)+MeshRenderer(1.4.1)
