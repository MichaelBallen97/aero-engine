...
TEST_CASE("transform: every World seeds engine::Transform by construction") {
    World w;
    CHECK(w.componentTypeCount() == 10);  // the ten built-ins, Transform first (1.3.2 .. E.2.2)
    ...
    World a;
    const World b;
    CHECK(a.componentTypeCount() == 10);  // the ten built-ins, Transform first (1.3.2 .. E.2.2)
    CHECK(b.componentTypeCount() == 10);  // the ten built-ins, Transform first (1.3.2 .. E.2.2)
...
TEST_CASE("transform: move semantics do not re-seed or lose the table") {
    ...
    CHECK(moved.componentTypeCount() == 10);  // the ten built-ins, Transform first (1.3.2 .. E.2.2)
